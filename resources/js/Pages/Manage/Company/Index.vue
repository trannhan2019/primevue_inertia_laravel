...
watch(
    () => [state.page.value, state.itemPerPage.value, state.search.value],
    () => {
        router.get(
            route("manage-company.index"),
            {
                page: state.page.value,
                item_per_page: state.itemPerPage.value,
        ...
        <div class="col-12">
            <div class="card">
                ...
                <Datatable
                    ...
                    v-model:selectedList="state.selectedList.value"
